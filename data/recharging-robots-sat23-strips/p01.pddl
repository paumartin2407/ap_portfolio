;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1229 3 5 10 1 p01.pddl p01.plan
;; Random seed: 1229
(define (problem recharge-single-source-move-to-locations-651)
