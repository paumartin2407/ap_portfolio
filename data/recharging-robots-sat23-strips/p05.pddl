;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1259 --move-from-source 6 5 30 1 p05.pddl p05.plan
;; Random seed: 1259
(define (problem recharge-single-source-move-to-locations-6440)
...
(:goal
  (and
    (at robot-00 location-0035)
    (at robot-01 location-0038)
    (at robot-02 location-0036)
    (at robot-03 location-0044)
    (at robot-04 location-0022)
    (at robot-05 location-0003)
  )
)
