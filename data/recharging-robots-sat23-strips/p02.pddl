;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1231 4 5 15 1 p02.pddl p02.plan
;; Random seed: 1231
(define (problem recharge-single-source-move-to-locations-3636)
