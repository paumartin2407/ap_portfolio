;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1249 --move-from-source 5 5 20 1 p04.pddl p04.plan
;; Random seed: 1249
(define (problem recharge-single-source-move-to-locations-8449)
...
(:goal
  (and
    (at robot-00 location-0010)
    (at robot-01 location-0030)
    (at robot-02 location-0018)
    (at robot-03 location-0002)
    (at robot-04 location-0012)
  )
)
