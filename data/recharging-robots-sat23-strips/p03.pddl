;; Genearated with: ../../../domain-recharging-robots/generator.py single-source-move-to-locations --random-seed 1237 --move-from-source 4 5 20 1 p03.pddl p03.plan
;; Random seed: 1237
(define (problem recharge-single-source-move-to-locations-2356)
