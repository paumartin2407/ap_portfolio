...
Para ello utilizaremos 1000 problemas del repositorio de la competición IPC utilizado para la práctica de Fast Downward (directorio _{ROOT_DIR}/data/}_).
...
Una vez que tenemos las características, utilizamos el script _{ROOT_DIR}/problem_solving.py_ para resolver los problemas con los planificadores deseados. Los logs de las ejecuciones no están subidos al repositorio, ya que ocupan mucho espacio. Sí los tenemos en nuestros ordenadores locales por si fuera necesario subirlos.
